...
class Color
{
    ...
    public static function hasPalette(string $name): bool
    {
        return array_key_exists(strtolower(trim($name)), static::catalog());
    }
    ...
    {
        return static::catalog()[strtolower(trim($name))] ?? null;
    }

    public static function get(string $name, int $shade = 500): ?string
    {
        $palette = static::palette($name);
